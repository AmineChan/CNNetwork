...
NSString *const OSCDeserializationErrorDomainKey = @"OSCDeserializationErrorDomainKey";

NSInteger const OSCTypeMismatchErrorCode = 143553;

NSInteger const OSCEmptyValueOccurredErrorCode = 143509;

NSInteger const OSCUnknownResponseObjectErrorCode = 143528;


@interface OSCResponseDeserializer ()
...
@implementation OSCResponseDeserializer
...
- (NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:OSCDeserializationErrorDomainKey code:OSCTypeMismatchErrorCode userInfo:userInfo];
}
...
- (NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:OSCDeserializationErrorDomainKey code:OSCEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
- (NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:OSCDeserializationErrorDomainKey code:OSCUnknownResponseObjectErrorCode userInfo:userInfo];
}
